...
def main():
  ...
  b = [78, 100, 77, 46, 31, 77, 97, 64, 69, 75]

  for i in b:
    tree_b.insert(i)

  c = [94, 50, 64, 87, 99, 84, 54, 93, 80, 76, 90, 60, 95, 17, 38, 72, 15, 
  ...
  print("A and B similar:", tree_a.is_similar(tree_b))
  tree_a.print_level(1)
  tree_b.print_level(3)
  tree_c.print_level(5)

  print(tree_a.get_height())
  print(tree_b.get_height())
  print(tree_c.get_height())

  print(tree_a.num_nodes())
  print(tree_b.num_nodes())
